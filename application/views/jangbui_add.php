...
<script>
    ...
    function select_product()
    {
        ...
        if(str == "")                         // 선택하세요 인 경우
        {
            ...
            form1.prices.value = Number(form1.price.value) * Number(form1.numi.value);  // 금액
        }
    }
...
<table class="table table-sm table-bordered mymargin5">
    ...
    <tr>
        ...
        <td width="80%" align="left">
            <div class="form-inline">
                <input type="text" name="price" value="<?=set_value("price")?>" class="form-control form-control-sm" onChange="cal_prices();"/>
            </div>
        </td>
    </tr>
    <tr>
        ...
        <td width="80%" align="left">
            <div class="form-inline">
                <input type="text" name="numi" value="<?=set_value("numi")?>" class="form-control form-control-sm" onChange="cal_prices();"/>
            </div>
        </td>
    </tr>
    <tr>
        ...
        <td width="80%" align="left">
            <div class="form-inline">
                <input type="text" name="prices" value="<?=set_value("prices")?>" class="form-control form-control-sm" onChange="cal_prices();"/>
            </div>
        </td>
    </tr>
    <tr>
        ...
        <td width="80%" align="left">
            <div class="form-inline">
                <input type="text" name="bigo" value="<?=set_value("bigo")?>" class="form-control form-control-sm" />
            </div>
        </td>
    </tr>
